...
void init_scene(Scene* scene)
{
    ...
    load_model(&(scene->door), "assets/models/door.obj");
    ...
    scene->plank_id = load_texture("assets/textures/nyir.jpg");
    scene->help_id = load_texture("assets/textures/help.png");
    scene->black = load_texture("assets/textures/black.jpg");
...
void render_scene(const Scene* scene)
{
    ...
    glTranslatef(1.8f, 0.0f, -1.6f);
    glBindTexture(GL_TEXTURE_2D, scene->black);
    ...
    glTranslatef(0.84f, -0.4f, -0.3f);
    glRotatef(180, 0.0f, 0.0f , 1.0f);
    draw_plank(scene->plank_id);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(0.88f, 0.4f, -0.3f);
    draw_plank(scene->plank_id);
    glPopMatrix();
